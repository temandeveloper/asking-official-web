...
export const translations = {
  id: {
    ...
    integration: {
      ...
      ai_reply:
        "Halo! Tiket demo sudah kami buatkan (#TCK-1003) untuk besok pukul 10:00 WIB. Tim kami siap mendampingi via zoom meeting ya kak! 😊",
      ticket_id: "#TCK-1003",
  ...
  en: {
    ...
    integration: {
      ...
      ai_reply:
        "Hello! Your demo ticket (#TCK-1003) is confirmed for tomorrow at 10:00 AM. Our team is ready to assist via zoom meeting! 😊",
      ticket_id: "#TCK-1003",
      ticket_title: "Sales Team Live Onboarding Demo",
      ticket_category: "Support",
      ticket_priority: "Medium",
