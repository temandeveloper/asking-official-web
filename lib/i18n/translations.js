...
export const translations = {
  id: {
    ...
    hero: {
      ...
      headline_suffix: "Tanpa Pusing Biaya Berlangganan yang Mahal",
      subtitle:
        "AsKing adalah Customer Manager modern untuk manajemen tiket pelayanan, otomasi customer support, dan aktivitas marketing. Solusi terjangkau untuk mengelola data operasional secara lokal di perangkat Anda.",
      cta_primary: "Coba AsKing Gratis",
      cta_secondary: "Jelajahi Fitur",
      badge_local_data: "Data Operasional Lokal",
    ...
    privacy: {
      ...
      title: "Perbedaan Vendor Cloud CRM Tradisional dan AsKing Local-First Architecture",
      subtitle:
        "Bandingkan cara kerja CRM cloud tradisional dengan AsKing Local-First, termasuk perbedaan biaya dan tempat data operasional Anda disimpan.",
      ...
      cloud_crm_points: [
        "Rentan Resiko kebocoran data & insiden keamanan server cloud",
      ...
      asking_badge: "Data Operasional Lokal",
      asking_desc:
        "Data operasional utama seperti riwayat pesan, kontak, dan tiket dikelola melalui penyimpanan lokal perangkat Anda.",
      asking_points: [
        "Lebih terjangkau: Tidak bergantung pada biaya langganan cloud CRM bulanan untuk penyimpanan operasional",
        "Local-First: Data operasional utama dikelola di perangkat Anda",
    ...
    features: {
      ...
      // Card 1: Omnichannel
      omnichannel_title: "Multi-Channel Messaging",
      omnichannel_desc:
      ...
      // Card 6: Landing Page Studio
      landing_title: "Landing Page Studio & Publikasi Instan",
      landing_desc:
        "Bangun landing page profesional berkecepatan tinggi tanpa coding. Publikasikan instan ke subdomain resmi [brand]-app.godiscus.com atau custom domain dengan tombol closing langsung ke Channel Pesan pilihan Anda.",
      landing_badge: "Web Page Builder & Hosting",
      landing_subdomain_sample: "brandkamu-app.godiscus.com",
      landing_tag_speed: "*Single-File HTML (<100ms)",
      landing_tag_seo: "SEO-Ready",
      landing_tag_wa: "Direct WhatsApp Closing",
      landing_live_status: "Online • 200 OK",
      landing_preview_hero_title: "Solusi Terpercaya Pertumbuhan Bisnis Anda",
      landing_preview_hero_subtitle: "Katalog produk dan penawaran eksklusif langsung terhubung ke saluran chat Anda.",
      landing_preview_cta: "Arahkan Pelanggan ke Channel Chat Pilihan Anda",
      landing_feature_speed_title: "Ultra Ringan & Responsif",
      landing_feature_speed_desc: "Kompilasi ke HTML murni tanpa runtime berat untuk konversi maksimal.",
      landing_feature_domain_title: "Subdomain Resmi & Custom Domain",
      landing_feature_domain_desc: "*Publikasikan dalam hitungan detik.",
    },
    ...
    demo: {
      ...
      tabs: {
        ...
        landingpages: "Landing Pages Studio",
      ...
      modules: {
        ...
        landingpages: {
          ...
          tagline: "Bangun landing page bisnis tanpa coding dan publikasikan dalam hitungan detik.",
          badge: "Web Page Builder & Hosting",
          points: [
            "Publikasikan landing page profesional berkecepatan tinggi tanpa coding.",
            "Integrasi akun Telegram menggunakan sesi yang aman di perangkat",
            "Pemantauan status koneksi aktif perangkat secara langsung",
          ],
        },
    ...
    // 7. Statement of Concern
    concern: {
      body:
        "Manajemen pelanggan yang terstruktur penting untuk menjaga keberlanjutan bisnis, meningkatkan kualitas pelayanan, dan mendorong penjualan. Namun, pemilik bisnis sering harus membayar biaya berlangganan yang tinggi sekaligus menyimpan data mereka pada vendor aplikasi. Kekhawatiran terkait penggunaan data, dan risiko kebocoran data selalu menjadi pertimbangan penting.",
    },

    // 8. Founder
    founder: {
      tag: "Berkenalan dengan Founder",
      title: "Founder AsKing",
      body:
        "Perkenalkan, saya Ahmad Fadil, Founder AsKing dengan pengalaman profesional lebih dari 6 tahun di bidang web, desktop, dan AI development.",
      detail:
        "Sejalan dengan visi GoDiscus, AsKing dibangun untuk menghadirkan solusi bermanfaat dengan biaya operasional rendah dan kendali data yang jelas. Melalui prinsip Local-First menjaga data operasional utama tetap dikelola di perangkat pengguna.",
      mission:
        "Saya berharap AsKing dapat membantu owner mengelola pelayanan pelanggan, otomasi customer support, dan aktivitas marketing secara transparan, dengan biaya operasional rendah, serta mudah dioperasikan dengan tetap mengutamakan kendali pengguna atas data mereka.",
      author: "Ahmad Fadil",
      role: "Founder AsKing",
      link_label: "Lihat detail profil founder",
    },
    ...
    pricing: {
      ...
      subtitle:
        "Semua paket berlaku untuk 1 akun dan 1 perangkat desktop. Pilih langganan bulanan Pro atau lisensi sekali bayar Pro+ Business tanpa biaya berlangganan.",
      billed_monthly: "",
      ...
      trial_payment_note: "Gratis 15 hari. Pembayaran dilakukan setelah masa trial berakhir.",
      trial_ai_quota_label: "300 Credit AI Assistant (Uji Coba)",
      trial_cta: "Mulai Uji Coba Gratis",
      trial_features: [
        "Arsitektur Local-First dengan database sepenuhnya di perangkat Anda",
        "Multi-channel messaging dalam satu aplikasi (WhatsApp & Telegram)",
        "Visual Kanban Board untuk manajemen pelanggan",
        "AsKing AI Assistant untuk analisis manajemen operasional",
        "Autonomous AI Customer Agent untuk otomasi pesan",
        "300 Credit AI Assistant / 15 Hari",
      ...
      pro_discount_badge: "Promo Terbatas",
      ...
      pro_ai_quota_label: "1.500 Credit AI Assistant & Agent / Bulan",
      pro_cta: "Pilih Pro Business",
      pro_features: [
        "Arsitektur Local-First dengan database sepenuhnya di perangkat Anda",
        "Multi-channel messaging dalam satu aplikasi (WhatsApp & Telegram)",
        "Visual Kanban Board untuk manajemen pelanggan",
        "Buat landing page bisnis tanpa ribet coding, publikasikan dalam hitungan detik",
        "AsKing AI Assistant untuk analisis manajemen operasional",
        "Autonomous AI Customer Agent untuk otomasi pesan",
        "1.500 Credit AI Assistant & Agent / Bulan",
        "Penjadwalan broadcast pesan",
        "Template Interaktif & Tagging Pelanggan",
        "Manajemen kontak pelanggan",
        "Backup database otomatis",
        "Lifetime update fitur reguler",
      ],

      pro_plus_badge: "Bayar Sekali",
      pro_plus_title: "Pro+ Business",
      pro_plus_original_price: `Rp ${PRICING_CONFIG.proPlusOriginalPrice}`,
      pro_plus_price: `Rp ${PRICING_CONFIG.proPlusPrice}`,
      pro_plus_period: "Lisensi sekali bayar",
      pro_plus_desc:
        "Untuk owner yang ingin menghindari biaya software bulanan dengan akses fitur lengkap dan kuota AI yang dapat disesuaikan.",
      pro_plus_ai_quota_label: "Kuota AI sesuai kebutuhan",
      pro_plus_cta: "Pilih Pro+ Business",
      pro_plus_features: [
        "Seluruh fitur utama AsKing Desktop",
        "Lisensi sekali bayar untuk 1 akun dan 1 perangkat",
        "Tidak ada biaya software bulanan untuk lisensi Pro+",
        "Bundling 5000 Credit AI Assistant & Agent, dapat di top-up disesuaikan dengan kebutuhan Anda",
        "Bebas buat landing page bisnis sepuasnya tanpa biaya langganan web bulanan",
        "Gratis fitur atau update setiap ada pembaruan",
      ],
    },
    ...
    footer: {
      description:
        "AsKing adalah aplikasi Customer Manager Local-First untuk manajemen kanban tiket, integrasi omnichannel messaging, dan otomasi AI Customer Agent dengan data operasional utama yang dikelola secara lokal.",
    ...
    auth: {
      ...
      forgot_password_desc: "Masukkan email akun Anda. Jika akun memenuhi syarat, kami akan mengirimkan tautan untuk membuat kata sandi baru.",
      send_reset_link: "Kirim Tautan Reset",
      reset_sending: "Mengirim tautan...",
      reset_email_sent_title: "Periksa Email Anda",
      reset_email_sent_desc: "Jika alamat email terdaftar, tautan untuk mengatur ulang kata sandi telah dikirim. Periksa inbox dan folder spam Anda.",
      reset_email_invalid: "Masukkan alamat email yang valid.",
      reset_request_failed: "Kami belum dapat memproses permintaan ini. Silakan coba lagi beberapa saat lagi.",
      auth_unavailable: "Layanan autentikasi belum tersedia. Silakan coba lagi nanti.",
      reset_password_title: "Buat Kata Sandi Baru",
      reset_password_desc: "Pilih kata sandi baru untuk akun AsKing Anda.",
      ...
      update_password_btn: "Simpan Kata Sandi Baru",
      reset_updating: "Memperbarui kata sandi...",
      reset_password_too_short: "Kata sandi minimal 6 karakter.",
      reset_password_mismatch: "Konfirmasi kata sandi tidak cocok.",
      reset_password_failed: "Kata sandi belum dapat diperbarui. Silakan minta tautan reset baru.",
      reset_link_invalid_title: "Tautan Reset Tidak Berlaku",
      reset_link_invalid_desc: "Tautan ini sudah kedaluwarsa atau telah digunakan. Minta tautan reset baru untuk melanjutkan.",
      request_new_reset_link: "Minta Tautan Reset Baru",
      reset_checking_link: "Memeriksa tautan reset...",
      password_reset_success_title: "Kata Sandi Berhasil Diperbarui",
      password_reset_success_desc: "Silakan masuk menggunakan kata sandi baru Anda.",
    ...
    profile: {
      ...
      unverified_badge: "Belum Verifikasi",
      send_verification_btn: "Kirim Link Verifikasi",
      sending_verification: "Mengirim Link...",
      verification_link_sent: "Link verifikasi telah dikirim ke {email}. Silakan periksa inbox atau folder spam Anda.",
      verification_verified_banner: "Selamat! Alamat email Anda telah berhasil diverifikasi.",
      verification_modal_title: "Tautan Verifikasi Terkirim",
      verification_modal_subtitle: "Silakan periksa kotak masuk atau folder spam email Anda untuk mengonfirmasi akun.",
      verification_modal_btn: "Saya Mengerti",
      verification_tip_1: "Buka email masuk dari AsKing (atau pada folder spam)",
      verification_tip_2: "Klik tombol atau tautan \"Konfirmasi & Masuk ke Akun\"",
      verification_tip_3: "Halaman profil akan otomatis berstatus Terverifikasi",
      resend_in: "Kirim ulang dalam",
      email_note_unverified: "Email belum diverifikasi. Klik tombol di atas untuk mengirim link konfirmasi.",
      email_note_verified: "Alamat email Anda telah terverifikasi secara resmi.",
      unverified_header_caption_badge: "Akses Aktif",
      unverified_header_caption_text: "Anda dapat langsung mengunduh dan mulai menggunakan aplikasi AsKing Desktop sekarang. Konfirmasi email dapat diselesaikan kapan saja untuk mengamankan akun Anda.",
      unverified_header_caption_action: "Verifikasi Sekarang",
      ...
      plan_pro_plus_business: "Pro+ Business",
      ...
      plan_lifetime: "Lifetime (Akses Seumur Hidup)",
      plan_lifetime_badge: "Lifetime (Tanpa Batas Sisa Hari)",
      plan_ai_budget: "Batas Kuota AI Request",
      plan_ai_budget_desc: "Maksimal kuota credit AI assistant per siklus",
      upgrade_plan_btn: "Pembayaran",
      renew_plan_btn: "Pembayaran",
      request_demo_btn: "Minta Demo",
      open_app_btn: "Buka Aplikasi AsKing",

      // Open App & Download Modal
      modal_app_badge: "Aplikasi Desktop",
      modal_app_title: "Buka Aplikasi AsKing",
      modal_app_subtitle: "Akses AsKing Customer Manager langsung di komputer Anda atau unduh aplikasi jika belum terpasang.",
      modal_app_installed_tag: "Sudah Memiliki Aplikasi",
      modal_app_installed_title: "Buka Langsung di Desktop",
      modal_app_installed_desc: "Buka aplikasi AsKing yang sudah terpasang di komputer Anda. Akun Anda akan otomatis terhubung secara instan tanpa perlu login ulang.",
      modal_app_installed_btn: "Buka Aplikasi Sekarang",
      modal_app_launching: "Membuka AsKing Desktop...",
      modal_app_launch_hint: "Browser mungkin meminta izin untuk membuka aplikasi. Klik \"Buka\" atau \"Open\" pada pop-up konfirmasi sistem.",
      modal_app_launch_retry: "Aplikasi belum terbuka? Klik untuk coba lagi",
      modal_app_not_installed_tag: "Belum Memiliki Aplikasi",
      modal_app_not_installed_title: "Unduh AsKing Desktop",
      modal_app_not_installed_desc: "Dapatkan installer resmi AsKing Customer Manager untuk Windows 10 & 11 melalui Microsoft Store dengan instalasi aman dan pembaruan otomatis.",
      modal_app_download_btn: "Download AsKing Desktop",
      modal_app_ms_store: "Tersedia Resmi di Microsoft Store",
      modal_app_windows_badge: "Windows 10 / 11",
      modal_app_other_platforms: "Dukungan macOS & Linux segera hadir",
      modal_app_sync_note: "Sesi login akun web Anda akan otomatis disinkronkan ke aplikasi desktop.",
      modal_app_close: "Tutup",

      // Upgrade Modal
      modal_upgrade_title: "Pembayaran Paket",
      modal_upgrade_subtitle: "Dapatkan akses penuh ke fitur AI dan otomasi tanpa batasan.",
      modal_select_plan: "1. Pilih Paket",
      modal_pro_title: "Pro Business",
      modal_pro_discount_badge: "Promo Terbatas",
      ...
      modal_pro_plus_title: "Pro+ Business",
      modal_pro_plus_badge: "Bayar Sekali",
      modal_pro_plus_desc: "Lisensi sekali bayar tanpa biaya software bulanan. Kuota AI dapat disesuaikan melalui penawaran khusus.",
      ...
      // Top Up AI Credit
      topup_ai_btn: "Top Up AI Credit",
      modal_topup_title: "Top Up AI Credit",
      modal_topup_subtitle: "Tambah kuota credit AI Assistant & Autonomous Customer Agent untuk akun Anda.",
      modal_topup_select_pack: "1. Pilih Paket Kuota AI",
      modal_topup_credits_label: "Credit AI",
      modal_topup_note: "Kuota credit AI bersifat akumulatif dan tidak memiliki masa kedaluwarsa bulanan.",
      modal_topup_confirm_btn: "Konfirmasi Top Up via WhatsApp",
      modal_topup_qr_title: "Scan QR Code Konfirmasi Top Up",
      modal_topup_qr_desc: "Silakan scan QR Code di bawah menggunakan kamera HP atau WhatsApp untuk mengirimkan konfirmasi pembayaran top up AI Credit ke Admin AsKing:",
    },
  },
  ...
  en: {
    ...
    hero: {
      ...
      headline_suffix: "Without the Burden of Expensive Subscription Fees",
      subtitle:
        "AsKing is a modern Customer Manager for service ticket management, customer support automation, and marketing workflows. An affordable solution for managing your operational data locally on your own device.",
      cta_primary: "Try AsKing Free",
      cta_secondary: "Explore Features",
      badge_local_data: "Local Operational Data",
      badge_omnichannel: "WhatsApp • Telegram • Live Chat",
    ...
    privacy: {
      ...
      title: "Traditional Vendor Cloud CRM vs. AsKing Local-First Architecture",
      subtitle:
        "Compare traditional cloud CRM storage and cost assumptions with AsKing Local-First, where core operational data is managed on your device.",
      ...
      asking_title: "AsKing Local-First Architecture",
      asking_badge: "Local Operational Data",
      asking_desc:
        "Core operational data such as conversations, contacts, and tickets is managed through local device storage.",
      asking_points: [
        "More affordable: No mandatory monthly cloud CRM storage subscription for core operations",
        "Local-First: Core operational data is managed on your device",
    ...
    features: {
      ...
      omnichannel_name_email: "Email",
      omnichannel_name_chat: "Live Chat Widget",
      omnichannel_desc_wa: "WhatsApp Integration",
      omnichannel_desc_tg: "Telegram Integration",
      omnichannel_desc_chat: "Coming Soon",
      omnichannel_desc_email: "Email Integration",
      omnichannel_status_wa: "Active",
      omnichannel_status_tg: "Coming Soon",
      omnichannel_status_chat: "Coming Soon",
      omnichannel_status_email: "Email Integration",
      omnichannel_disclaimer:
      ...
      // Card 6: Landing Page Studio
      landing_title: "Landing Page Studio & Instant Publishing",
      landing_desc:
        "Design high-converting, lightning-fast landing pages with zero coding. Publish instantly to an official [brand]-app.godiscus.com subdomain or custom domain with direct WhatsApp conversion triggers.",
      landing_badge: "Web Page Builder & Hosting",
      landing_subdomain_sample: "yourbrand-app.godiscus.com",
      landing_tag_speed: "*Single-File HTML (<100ms)",
      landing_tag_seo: "SEO-Ready",
      landing_tag_wa: "Direct WhatsApp Closing",
      landing_live_status: "Online • 200 OK",
      landing_preview_hero_title: "The Ultimate Solution for Business Growth",
      landing_preview_hero_subtitle: "Interactive product showcases and offers seamlessly connected to your direct messaging channels.",
      landing_preview_cta: "Consult via WhatsApp",
      landing_feature_speed_title: "Ultra-Lightweight & Responsive",
      landing_feature_speed_desc: "Compiles into clean standalone HTML with zero client-side bloat for top conversions.",
      landing_feature_domain_title: "Official Subdomains & Custom Domains",
      landing_feature_domain_desc: "*Publish professional landing pages instantly.",
    },
    ...
    concern: {
      body:
        "Structured customer management is important for business continuity, better service quality, and stronger sales. Yet business owners often have to pay high subscription fees while storing their data with an application vendor. Concerns about how data is used and the risk of data leaks are always important considerations.",
    },

    // 8. Founder
    founder: {
      tag: "Built Directly by the Founder",
      title: "AsKing Is Built by a Founder and Engineer Who Uses It Himself",
      body:
        "I am Ahmad Fadil, Founder & Engineer of AsKing, with more than 6 years of experience in web, desktop, and AI development.",
      detail:
        "Aligned with Godiscus, AsKing is built to deliver useful solutions with low operating costs and clear data control. Its Local-First principle keeps core operational data managed on the user's device.",
      mission:
        "AsKing helps business owners manage customer service, automate support, and run marketing activities in a transparent, affordable, and easy-to-operate way while keeping user control over data at the center.",
      author: "Ahmad Fadil",
      role: "Founder & Engineer of AsKing",
      link_label: "View founder profile",
    },
    ...
    pricing: {
      ...
      subtitle:
        "Every plan applies to 1 user account and 1 desktop device. Choose monthly Pro or a one-time Pro+ Business license with no per-message fees.",
      ...
      trial_payment_note: "Free for 15 days. Payment starts after the trial period ends.",
      trial_ai_quota_label: "300 AI Assistant Credits (Trial Quota)",
      trial_cta: "Start Free Trial",
      trial_features: [
        "Local-First architecture with a fully on-device database",
        "Multi-channel messaging in one app (WhatsApp & Telegram)",
        "Visual Kanban Board for customer management",
        "AsKing AI Assistant for operational management analysis",
        "Autonomous AI Customer Agent for message automation",
        "300 AI Assistant Credits / 15 Days",
      ...
      pro_discount_badge: "Limited Promo",
      pro_title: "Pro Business",
      pro_original_price: `Rp ${PRICING_CONFIG.proOriginalPrice}`,
      pro_price: `Rp ${PRICING_CONFIG.proPrice}`,
      pro_period: "/ month",
      ...
      pro_ai_quota_label: "1,500 AI Assistant & Agent Credits / Month",
      pro_cta: "Choose Pro Business",
      pro_features: [
        "Local-First architecture with a fully on-device database",
        "Multi-channel messaging in one app (WhatsApp & Telegram)",
        "Visual Kanban Board for customer management",
        "Create instant sales landing pages ready to close deals in WhatsApp with zero coding",
        "AsKing AI Assistant for operational management analysis",
        "Autonomous AI Customer Agent for message automation",
        "1,500 AI Assistant & Agent Credits / Month",
        "Scheduled message broadcasts",
        "Interactive Templates & Customer Tagging",
        "Customer contact management",
        "Automatic database backups",
        "Lifetime regular feature updates",
      ],

      pro_plus_badge: "One-Time Payment",
      pro_plus_title: "Pro+ Business",
      pro_plus_original_price: `Rp ${PRICING_CONFIG.proPlusOriginalPrice}`,
      pro_plus_price: `Rp ${PRICING_CONFIG.proPlusPrice}`,
      pro_plus_period: "One-time license",
      pro_plus_desc:
        "For owners who want to avoid monthly software fees with full core features and AI credits tailored to their needs.",
      pro_plus_ai_quota_label: "AI credits tailored to your needs",
      pro_plus_cta: "Choose Pro+ Business",
      pro_plus_features: [
        "All core AsKing Desktop features",
        "One-time license for 1 account and 1 device",
        "No monthly software fee for the Pro+ license",
        "Bundling 5,000 AI Assistant & Agent credits, top-up tailored to your needs",
        "Publish sales landing pages freely forever with zero monthly website subscriptions",
        "Free regular feature updates as they are released",
      ],
    },
    ...
    footer: {
      description:
        "AsKing is a Local-First Customer Manager for Kanban ticket workflows, omnichannel messaging, and AI Customer Agent automation with core operational data managed locally.",
    ...
    auth: {
      ...
      full_name_placeholder: "Input Full Name",
      ...
      forgot_password_desc: "Enter your account email. If the account is eligible, we will send a link to create a new password.",
      send_reset_link: "Send Reset Link",
      reset_sending: "Sending link...",
      reset_email_sent_title: "Check Your Email",
      reset_email_sent_desc: "If the email address is registered, a password reset link has been sent. Check your inbox and spam folder.",
      reset_email_invalid: "Enter a valid email address.",
      reset_request_failed: "We could not process this request yet. Please try again shortly.",
      auth_unavailable: "Authentication is not available yet. Please try again later.",
      reset_password_title: "Create a New Password",
      reset_password_desc: "Choose a new password for your AsKing account.",
      ...
      reset_updating: "Updating password...",
      ...
      reset_password_failed: "We could not update your password. Please request a new reset link.",
      reset_link_invalid_title: "Reset Link Is Invalid",
      reset_link_invalid_desc: "This link has expired or was already used. Request a new reset link to continue.",
      request_new_reset_link: "Request a New Reset Link",
      reset_checking_link: "Checking your reset link...",
      password_reset_success_title: "Password Updated Successfully",
      password_reset_success_desc: "Sign in using your new password.",
    ...
    profile: {
      ...
      send_verification_btn: "Send Verification Link",
      sending_verification: "Sending Link...",
      verification_link_sent: "Verification link has been sent to {email}. Please check your inbox or spam folder.",
      verification_verified_banner: "Congratulations! Your email address has been verified successfully.",
      verification_modal_title: "Verification Link Sent",
      verification_modal_subtitle: "Please check your inbox or spam folder to confirm your email account.",
      verification_modal_btn: "Got It",
      verification_tip_1: "Open the email received from AsKing (or in the spam folder)",
      verification_tip_2: "Click the \"Konfirmasi & Masuk ke Akun\" button or link",
      verification_tip_3: "Your profile will automatically update to Verified",
      resend_in: "Resend in",
      email_note_unverified: "Email is not verified yet. Click the button above to send a confirmation link.",
      email_note_verified: "Your email address is officially verified.",
      unverified_header_caption_badge: "Access is Ready",
      unverified_header_caption_text: "You can download and start using AsKing Desktop right away. Complete your email verification anytime to ensure full account security.",
      unverified_header_caption_action: "Verify Now",
      ...
      plan_lifetime: "Lifetime (Lifetime Access)",
      plan_lifetime_badge: "Lifetime (No Expiry)",
      plan_ai_budget: "AI Request Budget",
      plan_ai_budget_desc: "Maximum AI Assistant requests allocated for current cycle",
      upgrade_plan_btn: "Payment",
      renew_plan_btn: "Payment",
      request_demo_btn: "Request Demo",
      open_app_btn: "Open AsKing App",

      // Open App & Download Modal
      modal_app_badge: "Desktop Application",
      modal_app_title: "Open AsKing Application",
      modal_app_subtitle: "Access AsKing Customer Manager directly on your computer or download the app if not installed yet.",
      modal_app_installed_tag: "Already Have the App",
      modal_app_installed_title: "Launch Directly on Desktop",
      modal_app_installed_desc: "Open your installed AsKing desktop application. Your account session will connect instantly without needing to log in again.",
      modal_app_installed_btn: "Open App Now",
      modal_app_launching: "Opening AsKing Desktop...",
      modal_app_launch_hint: "Your browser may ask for permission to open the app. Click \"Open\" in the system confirmation prompt.",
      modal_app_launch_retry: "Didn't open? Click here to try again",
      modal_app_not_installed_tag: "Don't Have the App Yet",
      modal_app_not_installed_title: "Download AsKing Desktop",
      modal_app_not_installed_desc: "Get the official AsKing Customer Manager for Windows 10 & 11 via Microsoft Store with secure installation and auto-updates.",
      modal_app_download_btn: "Download AsKing Desktop",
      modal_app_ms_store: "Available on Microsoft Store",
      modal_app_windows_badge: "Windows 10 / 11",
      modal_app_other_platforms: "macOS & Linux support coming soon",
      modal_app_sync_note: "Your web account session will automatically sync to your desktop application.",
      modal_app_close: "Close",

      // Upgrade Modal
      modal_upgrade_title: "Plan Payment",
      modal_upgrade_subtitle: "Unlock full AI automation, WhatsApp omnichannel, and unlimited workflows.",
      modal_select_plan: "1. Select Plan",
      modal_pro_title: "Pro Business",
      modal_pro_discount_badge: "Limited Promo",
      modal_pro_original_price: `Rp ${PRICING_CONFIG.proOriginalPrice}`,
      modal_pro_price: `Rp ${PRICING_CONFIG.proPrice}`,
      ...
      modal_pro_plus_title: "Pro+ Business",
      modal_pro_plus_badge: "One-Time Payment",
      modal_pro_plus_desc: "One-time license with no monthly software fee. AI credits can be tailored through a custom quote.",
      ...
      // Top Up AI Credit
      topup_ai_btn: "Top Up AI Credits",
      modal_topup_title: "Top Up AI Credits",
      modal_topup_subtitle: "Add AI Assistant & Autonomous Customer Agent credits to your account.",
      modal_topup_select_pack: "1. Select AI Credit Package",
      modal_topup_credits_label: "AI Credits",
      modal_topup_note: "AI credits are cumulative and do not expire monthly.",
      modal_topup_confirm_btn: "Confirm Top Up via WhatsApp",
      modal_topup_qr_title: "Scan QR Code for Top Up Confirmation",
      modal_topup_qr_desc: "Scan the QR code below using your phone camera or WhatsApp to send top-up payment proof directly to the AsKing Admin:",
    },
  },
};
