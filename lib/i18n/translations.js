...
export const translations = {
  id: {
    ...
    pricing: {
      ...
      trial_ai_quota_label: "50 Credit AI Assistant (Uji Coba)",
      ...
      trial_features: [
        ...
        "50 Credit AI Assistant / 15 Hari (Sangat Terbatas)",
        "Dukungan Komunitas & Dokumentasi",
      ],

      pro_badge: "🌟 Paling Populer",
      pro_discount_badge: "Harga Perpanjangan Flat, Promo Terbatas",
      ...
      pro_ai_quota_label: "1.000 Credit AI Assistant & Agent / Bulan",
      ...
      pro_features: [
        ...
        "1.000 Credit AI Assistant & Agent / Bulan",
    ...
    profile: {
      ...
      billing_desc: "Informasi paket aktif, masa berlaku, dan kuota credit AI akun Anda",
      ...
      plan_ai_budget_desc: "Maksimal kuota credit AI assistant per siklus",
      ...
      modal_pro_discount_badge: "Harga Perpanjangan Flat, Promo Terbatas",
  ...
  en: {
    ...
    pricing: {
      ...
      pro_discount_badge: "Flat Payment subscription, Limited Promo",
      pro_title: "Pro Business",
      pro_original_price: `Rp ${PRICING_CONFIG.proOriginalPrice}`,
      pro_price: `Rp ${PRICING_CONFIG.proPrice}`,
      pro_period: "/ month",
    ...
    profile: {
      ...
      modal_pro_title: "Pro Business",
      modal_pro_discount_badge: "Flat Payment subscription, Limited Promo",
      modal_pro_original_price: `Rp ${PRICING_CONFIG.proOriginalPrice}`,
      modal_pro_price: `Rp ${PRICING_CONFIG.proPrice}`,
