...
export const translations = {
  ...
  en: {
    ...
    hero: {
      ...
      headline_suffix: "Without Monthly Subscription Headaches",
      subtitle:
        "AsKing is a modern Customer Manager for service ticket management, customer support automation, and marketing workflows. Choose the monthly Pro plan or pay once with Pro+ Business to match your needs.",
    ...
    concern: {
      body:
        "Proper customer management matters for business continuity, better service, and stronger sales. Yet many owners must pay a recurring monthly fee while keeping operational data inside a software vendor's system. Concerns about data use, security, and potential exposure are reasonable parts of that decision.",
    },
