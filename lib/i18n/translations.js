export const translations = {
  id: {
    ...
    privacy: {
      ...
      asking_points: [
        ...
        "Privasi Mutlak: Vendor AsKing tidak menyimpan atau melihat chat pelanggan",
    ...
    features: {
      ...
      omnichannel_desc:
        "Hubungkan WhatsApp (aktif via engine Baileys), Telegram, dan Live Chat Widget langsung dalam satu window terpadu.",
      ...
      omnichannel_desc_tg: "Coming Soon",
      ...
      agent_guardrail: "Strict Guardrail & Knowledge Grounded",
    ...
    demo: {
      tag: "Demo Interaktif Langsung",
      title: "Uji Coba AsKing Secara Real-Time",
      subtitle: "Pilih tab di bawah untuk melihat bagaimana AsKing menyederhanakan alur kerja harian pelanggan Anda.",
      tab_messages: "Pesan & Saluran",
      tab_kanban: "Tiket Kanban",
      tab_assistant: "AsKing AI Assistant",
      tab_agent: "Simulator AI Agent",
    },

    // 6. Node Workflow Section
    integration: {
      tag: "Otomasi Alur Kerja",
      title: "Dari Chat WhatsApp Menjadi Tiket Kanban Otomatis",
      subtitle:
      ...
      customer_msg:
        "Halo min, kami tertarik beli paket AsKing Pro untuk tim. Ada jadwal demo besok jam 10 pagi?",
      ai_reply:
        "Halo! Tiket demo sudah kami buatkan (#TCK-1003) untuk besok pukul 10:00 WIB. Link meeting telah dikirimkan. Tim kami siap mendampingi! 😊",
      ticket_id: "#TCK-1003",
    ...
    pricing: {
      ...
      trial_badge: "14 Hari Uji Coba Penuh",
      trial_title: "Free Trial",
      trial_price: "Rp 0",
      trial_period: "selama 14 hari",
      trial_desc:
    ...
    profile: {
      ...
      upgrade_plan_btn: "Upgrade ke Pro Business",
      renew_plan_btn: "Perpanjang Paket",

      // Upgrade Modal
      modal_upgrade_title: "Upgrade ke Pro Business",
      ...
      modal_pro_discount_badge: "Diskon 50% Promo Terbatas",
      modal_pro_original_price: "Rp 149.000",
      modal_pro_price: "Rp 74.500",
      ...
      modal_advance_price: "Coming Soon",
  ...
  en: {
    ...
    features: {
      ...
      omnichannel_title: "Omnichannel Message Channels",
      omnichannel_desc:
        "Connect WhatsApp (active via secure Baileys engine), Telegram, and Live Chat Widget directly within a unified desktop window.",
      omnichannel_name_wa: "WhatsApp",
      omnichannel_name_tg: "Telegram",
      omnichannel_name_chat: "Live Chat Widget",
    ...
    // 5. Interactive Demo / App Explorer
    demo: {
      tag: "Live Interactive Preview",
      title: "Test-Drive AsKing in Real-Time",
      subtitle: "Select a tab below to see how AsKing streamlines daily customer workflows.",
      tab_messages: "Messages & Channels",
      tab_kanban: "Kanban Tickets",
      tab_assistant: "AsKing AI Assistant",
      tab_agent: "Customer Agent Simulator",
    },

    // 6. Node Workflow Section
    integration: {
      tag: "Workflow Automation",
      title: "From WhatsApp Chat to Automated Kanban Ticket",
      subtitle:
      ...
      customer_label: "Customer",
      customer_msg:
        "Hi team, we're interested in purchasing AsKing Pro for our team. Can we schedule a demo tomorrow at 10 AM?",
      ai_reply:
        "Hello! Your demo ticket (#TCK-1003) is confirmed for tomorrow at 10:00 AM. Meeting invite has been sent. Our team is ready to assist! 😊",
      ticket_id: "#TCK-1003",
      ticket_title: "Sales Team Live Onboarding Demo",
      ticket_category: "Support",
      ticket_priority: "Medium",
    ...
    pricing: {
      ...
      custom_price: "Coming Soon",
      trial_badge: "14-Day Free Access",
      trial_title: "Free Trial",
      trial_price: "Rp 0",
      trial_period: "for 14 days",
      trial_desc:
      ...
      trial_features: [
        "1 Active WhatsApp Account (Baileys Engine)",
        ...
        "50 AI Assistant Requests / 14 Days (Limited Trial)",
        "Community & Documentation Support",
      ],

      pro_badge: "🌟 Most Popular",
      pro_discount_badge: "50% OFF Limited Promo",
      pro_title: "Pro Business",
      pro_original_price: "Rp 149.000",
      pro_price: "Rp 74.500",
      pro_period: "/ month",
    ...
    profile: {
      ...
      upgrade_plan_btn: "Upgrade to Pro Business",
      renew_plan_btn: "Renew Plan",

      // Upgrade Modal
      modal_upgrade_title: "Upgrade to Pro Business",
      ...
      modal_pro_title: "Pro Business",
      modal_pro_discount_badge: "50% OFF Limited Promo",
      modal_pro_original_price: "Rp 149.000",
      modal_pro_price: "Rp 74.500",
