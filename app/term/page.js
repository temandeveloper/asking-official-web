              ...
              <div className="space-y-10 text-sm text-[#4B6055] leading-relaxed">
                ...
                <section className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1.5 pl-2">
                    ...
                    <li>Untuk lisensi yang dibayar satu kali (one-time payment), tidak ada pembatalan atau perpanjangan berulang. Permintaan refund dapat diajukan paling lambat 14 hari kalender sejak pembayaran atau aktivasi lisensi, mana yang lebih dahulu, dan akan ditinjau berdasarkan tingkat penggunaan, aturan payment provider, serta hukum yang berlaku.</li>
                    <li>Refund untuk lisensi yang dibayar satu kali (one-time payment) dapat dipertimbangkan apabila aktivasi atau provisioning gagal dan tidak dapat diperbaiki secara wajar, terjadi transaksi ganda atau tidak sah, atau terdapat keadaan lain yang diwajibkan hukum. Setelah aplikasi digunakan secara material, lisensi diaktifkan pada perangkat, atau credit AI digunakan, refund dapat ditolak secara proporsional atau seluruhnya.</li>
                    <li>Apabila refund untuk lisensi yang dibayar satu kali (one-time payment) disetujui, hak penggunaan lisensi dan akses terkait akan dihentikan atau dicabut setelah refund diproses. Biaya layanan pihak ketiga atau biaya payment provider yang tidak dapat dikembalikan dapat dikecualikan sepanjang diizinkan hukum.</li>
              ...
              <div className="space-y-10 text-sm text-[#4B6055] leading-relaxed">
                ...
                <section className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-1.5 pl-2">
                    ...
                    <li>For a one-time license, there is no recurring cancellation or renewal. A refund request may be submitted within 14 calendar days from payment or license activation, whichever occurs first, and remains subject to usage review, payment-provider rules, and applicable law.</li>
                    <li>A one-time license refund may be considered where activation or provisioning fails and cannot reasonably be corrected, for duplicate or unauthorized transactions, or where required by law. Once the application has been materially used, the license has been activated on a device, or AI credits have been consumed, a refund may be denied in whole or in proportion to the usage.</li>
                    <li>If a one-time license refund is approved, the license and related access rights will be terminated or revoked after the refund is processed. Non-refundable third-party or payment-provider fees may be excluded where permitted by law.</li>
